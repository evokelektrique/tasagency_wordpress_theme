<?php
/**
 * Template Name: Content Production
 */
get_header(); ?>
...
<div class="container">
  <div class="intro-section-container container">
    ...
    <div class="imageHeader">
      <img src="<?= get_template_directory_uri() . '/dist' ?>/images/UIUX-boy.png" class="uiboy" alt="" />
      <img src="<?= get_template_directory_uri() . '/dist' ?>/images/Pen tool.png" class="Pentool" alt="" />
      <img src="<?= get_template_directory_uri() . '/dist' ?>/images/Bucket.png" class="Bucket" alt="" />
      <img src="<?= get_template_directory_uri() . '/dist' ?>/images/bgui-element.png" class="backgroundel" alt="" />
    </div>
  </div>
