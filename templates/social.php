...
<div class="container">
  <div class="intro-section-container container">
    <div class="content">
      <h4 class="first-head-text primary-text">صدای رسای برند شما خواهیم بود</h4>
      <h1 class="primary-dark main-head-text">مدیریت پیج اینستاگرام</h1>
      <p class="p description-text description-color">
        بزرگ‌ترین کانال ورودی به وب‌سایت شما، جستجو است. پس سئو و بهینه سازی وب سایت در افزایش ترافیک هدفمند و مرتبط نقش اساسی دارد. البته، اولین شرط رسیدن به رتبه‌های اول گوگل، برنامه‌ریزی اصولی و یک استراتژی سئوی حرفه‌ای است.
      </p>
      <div class="btnGroup">
    ...
    <div class="imageHeader">
      <img src="<?= get_template_directory_uri() . "/dist" ?>/images/Social-boy.png" class="socialboy" alt="" />
    ...
    <div class="steps">
      ...
      >
        <div class="head">
          ...
          <h5 class="main-head-text">تحقیق کلمات کلیدی و شناخت رقبا</h5>
        </div>
        <p class="p-small description-color">گزارش کامل و دقیقی از جایگاه فعلی شما، وضعیت رقبایتان، قله هایی که باید فتح کنیم و مسیر رسیدن به آنها را در این مرحله به شما ارائه می‌کنیم.</p>
      </div>
      ...
      >
        <div class="head">
          ...
          <h5 class="main-head-text">سئو داخلی و خارجی</h5>
        </div>
        <p class="p-small description-color">سپس به کمک ابزار های تخصصی سئو، اهدافی را که برنامه ریزی کرده ایم را محقق می‌کنیم، این کار با روش هایی مثل بک لینک سازی، تدوین استراتژِ ی محتوایی و... انجام میشود.</p>
      </div>
      ...
      >
        <div class="head">
          ...
          <h5 class="main-head-text">گزارش پیشرفت</h5>
        </div>
        <p class="p-small description-color">شما همواره در طول فرآیند همکاری از روند کار و نتیجه های آن آگاه خواهید بود، در انتها نیز ما بار دیگر اهداف و درصد پیشرفت را برای شما ارائه میکنیم</p>
      </div>
...
<div class="container">
  <div class="social-contact-container">
    <div class="social-contact-content">
      <h6 class="first-head-text primary-text">تولید محتوای بدون استراتژی...</h6>
      <h1 class="primary-dark main-head-text">مانند زنبور بی عسل</h1>
      <p class="description-color description-text">
        پلتفرم اینستاگرام با بیش از چهل میلیون کاربر ایرانی فعال، بستری مناسب برای ارائه
        محصولات، خدمات و برندسازی از کسب و کار شما خواهد بود، ما تمامی ملزوماتی که برای
        داشتن یک نمایش جذاب از برندتان به آن احتیاج دارید را برایتان فراهم می کنیم.
      </p>
      <div class="contact">
        <a href="/about.html"><button class="btnPrimary">مشاوره رایگان</button></a>
        <div class="phone">
          <img src="<?= get_template_directory_uri() . "/dist" ?>/images/footer-phone.svg" alt="" />
          <p class="primary-text">
            0513 713 5338 - 0930 491 4235
          </p>
        </div>
      </div>
    </div>
    <img class="image" src="<?= get_template_directory_uri() . "/dist" ?>/images/pig-social.png" alt="" />
  </div>
  <div class="blogs-section-container">
    <div class="content">
      <h5 class="cta-text first-head-text">بلاگ ما</h5>
      <h2 class="primary-dark main-head-text">مقالات بازاریابی اجتماعی</h2>
      <p class="description-color description-text">آخرین محتوا های تیم تولید محتوای ما در زمینه شبکه ها اجتماعی را در اینجا بخوانید</p>
    </div>
